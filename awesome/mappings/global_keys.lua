...
local globalkeys = gears.table.join(
	...
	awful.key({ modkey_secondary }, "Tab", function()
	...
	--
	-- Menubar
	awful.key({ modkey_secondary }, "space", function()
	...
	awful.key({}, "XF86AudioLowerVolume", function(c)
		awful.spawn.easy_async_with_shell("./.config/awesome/src/scripts/vol.sh decrease", function()
	...
	awful.key({}, "XF86AudioRaiseVolume", function(c)
		awful.spawn.easy_async_with_shell("./.config/awesome/src/scripts/vol.sh increase", function()
			awesome.emit_signal("module::volume_osd:show", true)
			awesome.emit_signal("module::slider:update")
			awesome.emit_signal("widget::volume_osd:rerun")
		end)
	...
	awful.key({}, "XF86AudioMute", function(c)
		awful.spawn("./.config/awesome/src/scripts/vol.sh mute")
		awesome.emit_signal("module::volume_osd:show", true)
		awesome.emit_signal("module::slider:update")
		awesome.emit_signal("widget::volume_osd:rerun")
